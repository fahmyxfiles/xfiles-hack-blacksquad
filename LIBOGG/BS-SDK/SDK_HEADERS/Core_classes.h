...
public:
	...
	struct FString LocalizeCombinationText ( struct FString Text, struct FString Replace, struct FString With, struct FString Replace01, struct FString With01, struct FString Replace02, struct FString With02, struct FString Replace03, struct FString With03 );
	...
	// Virtual Functions
	virtual void VirtualFunction00 ( );																			// 0x00A97CD0 (0x00)
	virtual void VirtualFunction01 ( );																			// 0x004DB740 (0x04)
	virtual void VirtualFunction02 ( );																			// 0x004EA2C0 (0x08)
	virtual void VirtualFunction03 ( );																			// 0x00A27980 (0x0C)
	virtual void VirtualFunction04 ( );																			// 0x00B88F40 (0x10)
	virtual void VirtualFunction05 ( );																			// 0x00DDD570 (0x14)
	virtual void VirtualFunction06 ( );																			// 0x00637F90 (0x18)
	virtual void VirtualFunction07 ( );																			// 0x00480F60 (0x1C)
	virtual void VirtualFunction08 ( );																			// 0x00480FB0 (0x20)
	virtual void VirtualFunction09 ( );																			// 0x00516060 (0x24)
	virtual void VirtualFunction10 ( );																			// 0x004F17D0 (0x28)
	virtual void VirtualFunction11 ( );																			// 0x00A97CD0 (0x2C)
	virtual void VirtualFunction12 ( );																			// 0x0048B3F0 (0x30)
	virtual void VirtualFunction13 ( );																			// 0x004F35D0 (0x34)
	virtual void VirtualFunction14 ( );																			// 0x00519F40 (0x38)
	virtual void VirtualFunction15 ( );																			// 0x004532D0 (0x3C)
	virtual void VirtualFunction16 ( );																			// 0x00637F90 (0x40)
	virtual void VirtualFunction17 ( );																			// 0x0048B230 (0x44)
	virtual void VirtualFunction18 ( );																			// 0x00474570 (0x48)
	virtual void VirtualFunction19 ( );																			// 0x0050EC50 (0x4C)
	virtual void VirtualFunction20 ( );																			// 0x0048B300 (0x50)
	virtual void VirtualFunction21 ( );																			// 0x00474580 (0x54)
	virtual void VirtualFunction22 ( );																			// 0x004745C0 (0x58)
	virtual void VirtualFunction23 ( );																			// 0x004745D0 (0x5C)
	virtual void VirtualFunction24 ( );																			// 0x00637F90 (0x60)
	virtual void VirtualFunction25 ( );																			// 0x00637F90 (0x64)
	virtual void VirtualFunction26 ( );																			// 0x0060A9E0 (0x68)
	virtual void VirtualFunction27 ( );																			// 0x004745B0 (0x6C)
	virtual void VirtualFunction28 ( );																			// 0x004745C0 (0x70)
	virtual void VirtualFunction29 ( );																			// 0x004745D0 (0x74)
	virtual void VirtualFunction30 ( );																			// 0x004745C0 (0x78)
	virtual void VirtualFunction31 ( );																			// 0x004745D0 (0x7C)
	virtual void VirtualFunction32 ( );																			// 0x0049A070 (0x80)
	virtual void VirtualFunction33 ( );																			// 0x00501440 (0x84)
	virtual void VirtualFunction34 ( );																			// 0x005015B0 (0x88)
	virtual void VirtualFunction35 ( );																			// 0x00637F90 (0x8C)
	virtual void VirtualFunction36 ( );																			// 0x00525280 (0x90)
	virtual void VirtualFunction37 ( );																			// 0x0050C980 (0x94)
	virtual void VirtualFunction38 ( );																			// 0x004532F0 (0x98)
	virtual void VirtualFunction39 ( );																			// 0x00453320 (0x9C)
	virtual void VirtualFunction40 ( );																			// 0x00453350 (0xA0)
	virtual void VirtualFunction41 ( );																			// 0x00A27980 (0xA4)
	virtual void VirtualFunction42 ( );																			// 0x004550C0 (0xA8)
	virtual void VirtualFunction43 ( );																			// 0x00A27980 (0xAC)
	virtual void VirtualFunction44 ( );																			// 0x0060A9E0 (0xB0)
	virtual void VirtualFunction45 ( );																			// 0x0060A9E0 (0xB4)
	virtual void VirtualFunction46 ( );																			// 0x00637F90 (0xB8)
	virtual void VirtualFunction47 ( );																			// 0x00A27980 (0xBC)
	virtual void VirtualFunction48 ( );																			// 0x00954FE0 (0xC0)
	virtual void VirtualFunction49 ( );																			// 0x009B6B70 (0xC4)
	virtual void VirtualFunction50 ( );																			// 0x00515F10 (0xC8)
	virtual void VirtualFunction51 ( );																			// 0x004B7E20 (0xCC)
	virtual void VirtualFunction52 ( );																			// 0x00DDD570 (0xD0)
	virtual void VirtualFunction53 ( );																			// 0x00DDD570 (0xD4)
	virtual void VirtualFunction54 ( );																			// 0x0060A9E0 (0xD8)
	virtual void VirtualFunction55 ( );																			// 0x004DA3C0 (0xDC)
	virtual void VirtualFunction56 ( );																			// 0x0048B5A0 (0xE0)
	virtual void VirtualFunction57 ( );																			// 0x010206D0 (0xE4)
	virtual void VirtualFunction58 ( );																			// 0x00474550 (0xE8)
	virtual void VirtualFunction59 ( );																			// 0x004E73C0 (0xEC)
	virtual void VirtualFunction60 ( );																			// 0x00514680 (0xF0)
	virtual void VirtualFunction61 ( );																			// 0x004DA740 (0xF4)
	virtual void VirtualFunction62 ( );																			// 0x00A27980 (0xF8)
	virtual void VirtualFunction63 ( );																			// 0x00450990 (0xFC)
	virtual void VirtualFunction64 ( );																			// 0x004509B0 (0x100)
	virtual void VirtualFunction65 ( );																			// 0x00515840 (0x104)
	virtual void VirtualFunction66 ( );																			// 0x004746F0 (0x108)
	virtual void VirtualFunction67 ( );																			// 0x004D48C0 (0x10C)
	virtual void ProcessEvent ( class UFunction* pFunction, void* pParms, void* pResult = NULL );				// 0x004C4D40 (0x110)
};
...
public:
	...
	TArray< struct FString >                           KorScriptPaths;                                   		// 0x00F0 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	TArray< struct FString >                           ForceServerSideOnlyPaths;                         		// 0x00FC (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	unsigned char                                      UnknownData00[ 0xAC ];                            		// 0x0168 (0x00AC) MISSED OFFSET
...
// 0x05CC (0x0734 - 0x0168)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[ 0x5CC ];                           		// 0x0168 (0x05CC) MISSED OFFSET
