...
{
	class UObject*                                     TargetObject;                                     		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	TArray< class UObject* >                           CachedResourceList;                               		// 0x0004 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	TArray< class UObject* >                           ResourceList;                                     		// 0x0000 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned long                                      bIsDedicatedServer : 1;                           		// 0x000C (0x0004) [0x0000000000000080] [0x00000001] ( CPF_Parm )
};
...
struct UObject_execLocalizeCombinationText_Parms
{
	...
	struct FString                                     Replace01;                                        		// 0x0024 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     With01;                                           		// 0x0030 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     Replace02;                                        		// 0x003C (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     With02;                                           		// 0x0048 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     Replace03;                                        		// 0x0054 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     With03;                                           		// 0x0060 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     ReturnValue;                                      		// 0x006C (0x000C) [0x0000000000400580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink )
	// struct FString                                  _localizedText;                                   		// 0x0078 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct UObject_execStringToDWORD_Parms
{
	...
	struct Fdword                                      out_value;                                        		// 0x000C (0x0004) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
...
struct UObject_execDynamicLoadObject_Parms
{
	...
	unsigned long                                      bFlushObjLoading : 1;                             		// 0x0014 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	class UObject*                                     ReturnValue;                                      		// 0x0018 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UObject_execFindEnumIndex_Parms
{
	...
	struct FName                                       InName;                                           		// 0x0004 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	int                                                ReturnValue;                                      		// 0x000C (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
