...
{
	class UProperty*                                   Property;                                         		// 0x0000 (0x0004) [0x0000000000100000]              
	int                                                ArrayIndex;                                       		// 0x0004 (0x0004) [0x0000000000100000]              
};
...
struct FRelevantDelayInfo
{
	...
	float                                              FrontSideCheckDelayDelta;                         		// 0x0010 (0x0004) [0x0000000000100000]              
	struct FMap_Mirror                                 LastUpdateInfo;                                   		// 0x0014 (0x003C) [0x0000000000103002]              ( CPF_Const | CPF_Native | CPF_Transient )
};
...
struct FTraceHitInfo
{
	...
	int                                                BoneIndex;                                        		// 0x0018 (0x0004) [0x0000000000100000]              
	class UPrimitiveComponent*                         HitComponent;                                     		// 0x001C (0x0004) [0x0000000004180008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
struct FImpactInfo
{
	...
	struct FTraceHitInfo                               HitInfo;                                          		// 0x0034 (0x0020) [0x0000000000180000]              ( CPF_Component )
};
...
struct FOutlineProperty
{
	...
	struct FString                                     OverrideMaterialName;                             		// 0x001C (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UMaterialInterface*                          OverrideMaterial;                                 		// 0x0028 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      Width;                                            		// 0x002C (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      MinWidth;                                         		// 0x002D (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      BlendMode;                                        		// 0x002E (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseOriginalMaterial : 1;                         		// 0x0030 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bSuppressOtherOutline : 1;                        		// 0x0030 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      DisableDepthTest : 1;                             		// 0x0030 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      EnableDepthWrite : 1;                             		// 0x0030 (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bOverlaySurface : 1;                              		// 0x0030 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bDisableForeground : 1;                           		// 0x0030 (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
};
...
struct FKConvexElem
{
	TArray< struct FVector >                           VertexData;                                       		// 0x0000 (0x000C) [0x0000000000520001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
	TArray< struct FPlane >                            PermutedVertexData;                               		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< int >                                      FaceTriData;                                      		// 0x0018 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FVector >                           EdgeDirections;                                   		// 0x0024 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FVector >                           FaceNormalDirections;                             		// 0x0030 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FPlane >                            FacePlaneData;                                    		// 0x003C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
...
{
	TArray< struct FKSphereElem >                      SphereElems;                                      		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKBoxElem >                         BoxElems;                                         		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKSphylElem >                       SphylElems;                                       		// 0x0018 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FKConvexElem >                      ConvexElems;                                      		// 0x0024 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
struct FPreviewSkelMeshStruct
{
	...
	TArray< class USkeletalMesh* >                     PreviewSkelMesh;                                  		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UMorphTargetSet* >                   PreviewMorphSets;                                 		// 0x0014 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FPreviewSocketEntryStruct
{
	...
	class UObject*                                     PreviewMesh;                                      		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UAnimSet*                                    AnimsetToUse;                                     		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       BaseSequenceName;                                 		// 0x0010 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FName                                       DisplayName;                                      		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FPreviewSocketEntryStruct >         Attachments;                                      		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                RelatedPreviewAnimsetIndex;                       		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FLoadingUIInfo
{
	...
	struct FString                                     MapName;                                          		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ModeName;                                         		// 0x0018 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     Tip;                                              		// 0x0024 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     BGImgPath;                                        		// 0x0030 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     MinimapImgPath;                                   		// 0x003C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	unsigned long                                      bMapBeta : 1;                                     		// 0x0048 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bModeBeta : 1;                                    		// 0x0048 (0x0004) [0x0000000000000000] [0x00000002] 
	struct FString                                     ClanMatchTitle;                                   		// 0x004C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanName_Left;                           		// 0x0058 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanName_Right;                          		// 0x0064 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanEmblemPath_Left;                     		// 0x0070 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     ClanMatchClanEmblemPath_Right;                    		// 0x007C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FWorldCube
{
	class UTextureCube*                                TextureCube;                                      		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
{
	class AActor*                                      PreviousTickableActor;                            		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      PostTickableActor;                                		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< class AActor* >                            ActorList;                                        		// 0x0000 (0x000C) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FPostProcessSettingsOverride
{
	...
	unsigned long                                      bEffectMaintain : 1;                              		// 0x017C (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              EffectMaintainDuration;                           		// 0x0180 (0x0004) [0x0000000000000000]              
	float                                              CurrentEffectMaintainTime;                        		// 0x0184 (0x0004) [0x0000000000000000]              
};
...
struct FOnlineProfileSetting
{
	...
	struct FSettingsProperty                           ProfileSetting;                                   		// 0x0008 (0x0014) [0x0000000000000000]              
};
...
struct FSkeletalMeshLODInfo
{
	...
	TArray< int >                                      LODMaterialMap;                                   		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< unsigned long >                            bEnableShadowCasting;                             		// 0x0018 (0x000C) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
	TArray< unsigned char >                            TriangleSorting;                                  		// 0x0024 (0x000C) [0x0000000020400000]              ( CPF_NeedCtorLink | CPF_Deprecated )
	TArray< struct FTriangleSortSettings >             TriangleSortSettings;                             		// 0x0030 (0x000C) [0x0000000000400041]              ( CPF_Edit | CPF_EditConstArray | CPF_NeedCtorLink )
	unsigned long                                      bDisableCompressions : 1;                         		// 0x003C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bHasBeenSimplified : 1;                           		// 0x003C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FMaterialSet
{
	...
	TArray< int >                                      MaterialPackageIndex;                             		// 0x000C (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< struct FString >                           PackageName;                                      		// 0x0018 (0x000C) [0x0000000000422000]              ( CPF_Transient | CPF_EditConst | CPF_NeedCtorLink )
};
...
struct FStaticMeshLODElement
{
	...
	TArray< class UMaterialInterface* >                MaterialSetList;                                  		// 0x0004 (0x000C) [0x0000000000001001]              ( CPF_Edit | CPF_Native )
	TArray< int >                                      MaterialSetPackageIndex;                          		// 0x0010 (0x000C) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	TArray< struct FName >                             MaterialSetPackageName;                           		// 0x001C (0x000C) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	unsigned long                                      bEnableShadowCasting : 1;                         		// 0x0028 (0x0004) [0x0000000000001001] [0x00000001] ( CPF_Edit | CPF_Native )
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x002C (0x0004) MISSED OFFSET
	unsigned long                                      bEnableCollision : 1;                             		// 0x0030 (0x0004) [0x0000000000001001] [0x00000001] ( CPF_Edit | CPF_Native )
};
